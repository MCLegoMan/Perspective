...
public class PerspectiveVersion implements Comparable<PerspectiveVersion> {
	...
	public PerspectiveVersion(String name, String id, int major, int minor, int patch, RTUReleaseTypes type, int build) {
		this.name = name;
		this.id = id;
		this.major = major;
		this.minor = minor;
	...
	@Override
	public int compareTo(PerspectiveVersion other) {
