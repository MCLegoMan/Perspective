...
public class PerspectiveData {
    ...
    public static final String VERSION = MAJOR_VERSION + "." + MINOR_VERSION + "." + PATCH_VERSION + "-" + RTUReleaseType.releaseTypeString(RELEASE_TYPE, RTUReleaseTranslationTypes.CODE) + (BUILD_VERSION < 0 ? "+dirty." + String.valueOf(BUILD_VERSION).replace("-", "") : "." + BUILD_VERSION);
