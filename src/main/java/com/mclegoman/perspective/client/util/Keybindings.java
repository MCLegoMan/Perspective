	...
	public static void tick() {
		if (!SEEN_CONFLICTING_KEYBINDING_TOASTS) {
			if (hasKeybindingConflicts()) {
				Data.version.sendToLog(Helper.LogType.WARN, Translation.getString("Conflicting Keybinding. Keybinding conflicts have been detected that could affect Perspective. Please take a moment to review and adjust your keybindings as needed."));
