...
public class ResourcePacks {
	...
	public static void init() {
        /*
            ...
            Contributor(s): MCLegoMan
        */
		//ResourceManagerHelper.registerBuiltinResourcePack(new Identifier("perspective_default"), FabricLoader.getInstance().getModContainer("perspective"), Translation.getTranslation(Data.version.getID(), "resource_pack.perspective_default"), ResourcePackActivationType.DEFAULT_ENABLED);
