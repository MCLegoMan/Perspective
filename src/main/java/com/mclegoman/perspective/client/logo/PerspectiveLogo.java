...
public class PerspectiveLogo {
	...
	// Whilst currently there are only three types, there will be more in the near future as they are re-worked.
	...
	private static String getPrideType() {
		if ((boolean) ConfigHelper.getConfig("force_pride_type")) {
			return prideTypes[(int)ConfigHelper.getConfig("force_pride_type_index")];
		} else {
