		...
		if (!Keybindings.HOLD_PERSPECTIVE_THIRD_PERSON_BACK.isPressed() && !HOLD_THIRD_PERSON_BACK_LOCK) {
			if (!HOLD_THIRD_PERSON_FRONT_LOCK) {
				...
				if (ClientData.minecraft.options.getPerspective().equals(net.minecraft.client.option.Perspective.THIRD_PERSON_FRONT))
					ClientData.minecraft.options.setPerspective(net.minecraft.client.option.Perspective.FIRST_PERSON);
				else ClientData.minecraft.options.setPerspective(net.minecraft.client.option.Perspective.THIRD_PERSON_FRONT);
			}
		...
		if (!Keybindings.HOLD_PERSPECTIVE_THIRD_PERSON_FRONT.isPressed() && !HOLD_THIRD_PERSON_FRONT_LOCK) {
			if (!HOLD_THIRD_PERSON_BACK_LOCK) {
				...
				if (ClientData.minecraft.options.getPerspective().equals(net.minecraft.client.option.Perspective.THIRD_PERSON_BACK))
					ClientData.minecraft.options.setPerspective(net.minecraft.client.option.Perspective.FIRST_PERSON);
				else ClientData.minecraft.options.setPerspective(net.minecraft.client.option.Perspective.THIRD_PERSON_BACK);
			}
