...
public class TexturedEntityModels {
	...
	public static final EntityModelLayer beeOverlay = new EntityModelLayer(Identifier.of("minecraft", "bee"), "outer");
	...
	public static final EntityModelLayer giantOverlay = new EntityModelLayer(Identifier.of("minecraft", "giant"), "outer");
	public static void init() {
		...
		EntityModelLayerRegistry.registerModelLayer(giantOverlay, () -> getBipedEntityModelData(new Dilation(0.5F), 64, 64));
	}
