...
public class Toast implements net.minecraft.client.toast.Toast {
	...
	public enum Type {
		INFO(0xFFAA00, 0x00AAAA, 4000L, Identifier.of(Data.version.getID(), "toast/warning")),
		WARNING(0xFFAA00, 0x00AAAA, 8000L, Identifier.of(Data.version.getID(), "toast/warning")),
		TUTORIAL(0xFFAA00, 0x00AAAA, 8000L, Identifier.of(Data.version.getID(), "toast/warning"));
