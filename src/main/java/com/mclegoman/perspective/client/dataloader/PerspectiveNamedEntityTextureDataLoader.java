...
public class PerspectiveNamedEntityTextureDataLoader extends JsonDataLoader implements IdentifiableResourceReloadListener {
    ...
    public static final String ID = "named_entity/texture";
    public PerspectiveNamedEntityTextureDataLoader() {
        super(new Gson(), ID);
    }
    @Override
    public void apply(Map<Identifier, JsonElement> prepared, ResourceManager manager, Profiler profiler) {
        try {
            ...
            PerspectiveData.LOGGER.error(PerspectiveData.PREFIX + "An error occurred whilst loading Named Entity Texture data.");
