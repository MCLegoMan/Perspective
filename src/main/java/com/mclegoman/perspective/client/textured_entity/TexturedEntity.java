...
public class TexturedEntity {
	public static void init() {
		try {
			...
			Data.version.sendToLog(Helper.LogType.ERROR, Translation.getString("Failed to initialize textured entity: {}", error));
		}
	}
	public static Identifier getTexture(Entity entity, String entity_type, String suffix, Identifier default_identifier) {
		try {
			...
			Data.version.sendToLog(Helper.LogType.ERROR, Translation.getString("Failed to set textured entity: {}", error));
		}
	...
	private static List<String> getStringRegistry(String entity_type) {
		...
		try {
			...
			Data.version.sendToLog(Helper.LogType.ERROR, Translation.getString("Failed to get textured entity: {}", error));
		}
