...
public class PerspectiveTexturedEntityConfigScreen extends Screen {
    ...
    public void init() {
        try {
            ...
            GRID_ADDER.add(PerspectiveConfigScreenHelper.createTitle(client, new PerspectiveTexturedEntityConfigScreen(PARENT_SCREEN)));
    ...
    private GridWidget createInformation() {
        ...
        GRID_ADDER.add(ButtonWidget.builder(Text.translatable("gui.perspective.config.textured_named_entity", PerspectiveTranslation.getVariableTranslation((boolean)PerspectiveConfigHelper.getConfig("named_textured_entity"), PerspectiveTranslationType.ONFF)), (button) -> {
            PerspectiveConfigHelper.setConfig("named_textured_entity", !(boolean)PerspectiveConfigHelper.getConfig("named_textured_entity"));
            client.setScreen(new PerspectiveTexturedEntityConfigScreen(PARENT_SCREEN));
        ...
        GRID_ADDER.add(ButtonWidget.builder(Text.translatable("gui.perspective.config.textured_random_entity", PerspectiveTranslation.getVariableTranslation((boolean)PerspectiveConfigHelper.getConfig("random_textured_entity"), PerspectiveTranslationType.ONFF)), (button) -> {
