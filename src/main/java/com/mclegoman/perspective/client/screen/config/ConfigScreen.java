...
public class ConfigScreen extends Screen {
	...
	private GridWidget createPageOne() {
		...
		GRID_ADDER.add(ButtonWidget.builder(Translation.getConfigTranslation(Data.version.getID(), "shaders"), (button) -> ClientData.CLIENT.setScreen(new ShadersConfigScreen(new ConfigScreen(PARENT_SCREEN, true, PAGE), false, false))).build());
		...
		GRID_ADDER.add(ButtonWidget.builder(Translation.getConfigTranslation(Data.version.getID(), "toasts"), (button) -> ClientData.CLIENT.setScreen(new ToastsConfigScreen(new ConfigScreen(PARENT_SCREEN, false, PAGE), false, false))).build());
