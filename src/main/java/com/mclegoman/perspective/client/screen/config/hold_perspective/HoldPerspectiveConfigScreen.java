...
public class HoldPerspectiveConfigScreen extends Screen {
	...
	public void init() {
		try {
			...
			Data.version.sendToLog(LogType.ERROR, Translation.getString("Failed to initialize config$hold_perspective screen: {}", error));
		}
	}
	...
	public void tick() {
		try {
			...
			Data.version.sendToLog(LogType.ERROR, Translation.getString("Failed to tick config$hold_perspective screen: {}", error));
		}
	}
