...
public class CreditsAttributionScreen extends Screen {
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		PerspectiveLogo.renderPerspectiveLogo(context, ClientData.CLIENT.getWindow().getScaledWidth() / 2 - 128, ClientData.CLIENT.getWindow().getScaledHeight() + 2, 256, 64, false);
	...
	public void renderBackground(DrawContext context, int mouseX, int mouseY, float tickDelta) {
		...
		context.drawTexture(new Identifier("minecraft", "textures/gui/options_background.png"), 0, 0, 0, 0.0F, this.time * 0.5F, ClientData.CLIENT.getWindow().getScaledWidth(), ClientData.CLIENT.getWindow().getScaledHeight(), 32, 32);
