...
public class CreditsAttributionScreen extends Screen {
	...
	protected void init() {
		if (this.credits == null) {
			...
			this.load(Identifier.of("perspective", "texts/credits.json"), this::readCredits);
	...
	public void render(DrawContext context, int mouseX, int mouseY, float delta) {
		...
		PerspectiveLogo.renderLogo(context, ClientData.minecraft.getWindow().getScaledWidth() / 2 - 128, ClientData.minecraft.getWindow().getScaledHeight() + 2, 256, 64, false);
	...
	public void renderBackground(DrawContext context, int mouseX, int mouseY, float tickDelta) {
		...
		context.drawTexture(Identifier.of("minecraft", "textures/gui/options_background.png"), 0, 0, 0, 0.0F, this.time * 0.5F, ClientData.minecraft.getWindow().getScaledWidth(), ClientData.minecraft.getWindow().getScaledHeight(), 32, 32);
