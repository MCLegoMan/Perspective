...
public class CreditsAttributionScreen extends Screen {
	...
	public void renderBackground(DrawContext context, int mouseX, int mouseY, float tickDelta) {
		...
		context.drawTexture(new Identifier("minecraft", "textures/gui/options_background.png"), 0, 0, 0, 0.0F, this.time * 0.5F, ClientData.minecraft.getWindow().getScaledWidth(), ClientData.minecraft.getWindow().getScaledHeight(), 32, 32);
